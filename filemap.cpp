...
namespace util {
    ...
    //=================================================================================
    auto filemap_t::map(const std::filesystem::path &filepath) ->std::uint8_t* {
        if (ptr != nullptr){
            unmap();
        }
        ...
        ptr = reinterpret_cast<std::uint8_t*>(::MapViewOfFile( hMap, FILE_MAP_READ, 0, 0, 0 ));
